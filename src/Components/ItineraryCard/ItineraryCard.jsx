...
const ItineraryCard = ({ title, location, creator, src }) => {
    return (
        <div className="realtive flex flex-col items-center self-stretch pb-3 my-auto rounded-2xl min-h-[480px] min-w-[240px] w-[270px]">
            <img src={src} alt={title} />
            <div className=" bottom-0 flex flex-col justify-center items-center max-w-full text-white min-h-[59px] w-[252px]">
